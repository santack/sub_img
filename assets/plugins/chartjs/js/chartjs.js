...
*/
    (function(global, factory) {
        ...
        function nextAvailableScaleId(axesOpts, prefix, index) {
            ...
            do {
                id = prefix + index++;
            } while (helpers$1.findIndex(axesOpts, hasId) >= 0);return id;
        }
        ...
        function generateTicks$1(generationOptions, dataRange) {
            ...
            } while (exp < endExp || (exp === endExp && significand < endSignificand));var lastTick = valueOrDefault$b(generationOptions.max, tickVal);
            ticks.push(lastTick);
            return ticks;
        }
        var defaultConfig$2 = {
